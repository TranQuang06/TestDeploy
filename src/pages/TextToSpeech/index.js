  ...
  const convertToSpeech = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || 'Không thể chuyển đổi văn bản thành giọng nói');
      }
        ...
        audioRef.current.oncanplay = () => {
          audioRef.current.play()
            ...
            .catch(e => {
              ...
              setError('Không thể phát âm thanh tự động. Vui lòng nhấn nút Phát.');
              setIsLoading(false);
            });
        };
      ...
      if (isPlaying) {
        ...
        audioRef.current.play()
          ...
          .catch(e => {
            ...
            setError('Không thể phát âm thanh. Có thể do chính sách bảo mật của trình duyệt.');
          });
      }
    }
  };
      ...
      <div className={styles.container}>
        ...
        <div className={styles.controls}>
          <div className={styles.controlGroup}>
            <label htmlFor="voice-select">Chọn giọng đọc:</label>
            <select 
              id="voice-select"
              value={selectedVoice}
        ...
        <div className={styles.infoBox}>
          <p>Thông tin:</p>
          <ul>
            <li>Sử dụng công nghệ AI tiên tiến từ ElevenLabs để tạo giọng đọc tự nhiên như người thật</li>
            <li>Hỗ trợ nhiều ngôn ngữ và giọng đọc khác nhau</li>
            <li>Giới hạn 500 ký tự mỗi lần chuyển đổi để tối ưu hiệu suất</li>
            <li>Âm thanh được tạo ra có chất lượng cao, phù hợp cho các ứng dụng chuyên nghiệp</li>
          </ul>
        </div>
      </div>
      <Footer />
